...
class MoviePageController extends Controller
{
    ...
    {
        $movie = $this->movie->getMovie($id);
        return View::make('admin.Movie.edit', compact('movie'));
    }
    ...
    public function store(Request $request, $id = null)
    {
        ...
        if (!is_null($id)) {
            $this->movie->createOrUpdateMovie($id, $collection);
        } else {
            $this->movie->createOrUpdateMovie($id = null, $collection);
        }
    ...
    public function cast(Request $request, $id = null)
    {
        ...
        if (!is_null($id)) {
            ...
            $this->movie->createOrUpdateCast($id, $collection);
        } else {
            $this->movie->createOrUpdateCast($id = null, $collection);
        }
