            ...
            <div class="row">
                <div class="col-md-12" style="font-size: 15px">
                    <div class="card card-primary">
                        ...
                        <form role="form" action="{{route('theatres-save')}}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" style="font-size: 15px;height: 35px"
                                           id="theatre_name" name="theatre_name" placeholder="Theater Name">
                                </div>

                                <div class="form-group">
                                    <label for="actor_bio">Total Seats</label>
                                    <input type="text" class="form-control" style="font-size: 15px;height: 35px"
                                           id="total_seats" name="total_seats" placeholder="Total Seats">
                                </div>

                            </div>
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" style="font-size: 18px">ADD</button>
                                <a type="button" href="{{ route('theatres-details') }}" class="btn btn-warning" style="font-size: 18px">Back</a>
                            </div>
                        </form>
                    </div>
                </div>
