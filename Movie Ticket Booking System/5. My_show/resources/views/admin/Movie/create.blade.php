                        ...
                        <form role="form" action="{{route('movies-save')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" style="font-size: 15px;height: 35px" id="movie_runtime" name="movie_runtime" placeholder="run_time">
                                </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a type="button"  href="{{ route('movies-details') }}" class="btn btn-warning" style="font-size: 18px">Back</a>
                            </div>
                        </form>
